...
const HelpPage = () => {
  ...
  console.log("Session in HelpPage:", session); // Debugging line
  return (
    <main className="container max-w-4xl mx-auto py-8 px-4">
      <div className="space-y-6">
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-lg border bg-card p-6 space-y-3">
            <p className="text-base">
              ...
              fyzických priečinkov s dokumentmi. Umožňuje vám jednoducho
              vytvárať záznamy, sledovať ich stav a efektívne spravovať vašu
              dokumentáciu.
            </p>
            <p className="text-base">
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-lg border bg-card p-6 space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-base">
                Použite vyhľadávacie pole na rýchle nájdenie záznamu podľa
                názvu, obsahu alebo iných údajov. Vyhľadávanie funguje v reálnom
                čase.
              </p>
            </div>
            <Separator />
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2">
                ...
                <li className="text-base">
                  <strong>Rok</strong> - filtrovať záznamy podľa konkrétneho
                  roku
                </li>
                <li className="text-base">
        ...
        <section className="space-y-4">
          ...
          <div className="rounded-lg border bg-card p-6 space-y-3">
            <ul className="list-disc list-inside space-y-2">
              ...
              <li className="text-base">
                <strong>Vypĺňajte obsah</strong> - podrobný popis obsahu
                uľahčuje neskoršie vyhľadávanie
              </li>
              <li className="text-base">
                <strong>Aktualizujte stav vydania</strong> - pravidelne
                označujte vydané priečinky
              </li>
              <li className="text-base">
        ...
        <div className="pt-6 pb-4 text-center text-sm text-muted-foreground">
          <p>
            Potrebujete ďalšiu pomoc? Kontaktujte správcu systému alebo
            navštívte{" "}
            <Link
